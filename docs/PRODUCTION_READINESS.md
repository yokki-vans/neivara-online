...
0.3.1 — **production-oriented vertical slice / technical preview**. Он использует production-практики для данных, CI, лицензирования ассетов и развёртывания, но **не является полноценной production MMO и не соответствует AAA-объёму контента**.
